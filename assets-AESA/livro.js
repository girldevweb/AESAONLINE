document.addEventListener('DOMContentLoaded', () => {
    const livros = [
        {
            id: 1, titulo: "A Oração na Bíblia", autor: "Maria José A. Elias", imagem: "images/oracao-na-biblia-1.jpg",
        ...
        {
            id: 2, titulo: "O Deus Presente", autor: "Maria José A. Elias", imagem: "images/o-Deus-presente-1.jpg",
        ...
        {
            id: 3, titulo: "A Família do Pastor e a Igreja", autor: "Maria José A. Elias", imagem: "images/a-familia-do-pastor-1.jpg",
        ...
        {
            id: 4, titulo: "Passos pelo caminho", autor: "Maria José A. Elias", imagem: "images/passos-do-caminho-1.jpg",
        ...
        {
            id: 5, titulo: "Propostas Bíblicas para a Liderança Cristã", autor: "Maria José A. Elias", imagem: "images/propostas-biblicas-1.jpg",
        ...
        {
            id: 6, titulo: "Sucata de Lembranças", autor: "Maria José A. Elias", imagem: "images/sucata-de-lembrancas-1.jpg",
        ...
        {
            id: 7, titulo: "Pescadores de Homens", autor: "Maria José A. Elias e Pr. Odélio Hertz", imagem: "images/pescadores-de-homens-1.jpg",
        ...
        {
            id: 8, titulo: "Cantigas para o meu Deus", autor: "Maria José A. Elias", imagem: "images/cantigas-para-o-meu-Deus-1.jpg",
        ...
        {
            id: 9, titulo: "Testemunhos Vivos", autor: "Rev. Antônio Elias", imagem: "images/testemunhos-vivos-1.png",
        ...
        {
            id: 10, titulo: "Família em Foco", autor: "Maria José A. Elias", imagem: "images/familia-em-foco-1.jpg",
        ...
        {
            id: 11, titulo: "Era sem forma e vazia...", autor: "Maria José A. Elias", imagem: "images/era-sem-forma-1.jpg",
        ...
        {
            id: 12, titulo: "Água feita vinho", autor: "Maria José A. Elias e Rev. Antônio Elias", imagem: "images/agua-feita-vinho-1.jpg",
        ...
        {
            id: 13, titulo: "O teu Deus, onde está?", autor: "Maria José A. Elias", imagem: "images/o-teu-Deus-onde-esta-1.jpg",
        ...
        {
            id: 14, titulo: "Sementeira da Palavra", autor: "Rev. Antônio Elias", imagem: "images/sementeira-da-palavra-1.jpg",
    ...
    if (livro) {
        ...
        document.getElementById('comprar-fisico').addEventListener('click', () => {
            alert('Redirecionando para a página de compra...');
            // Implemente a lógica real de redirecionamento para a página de compra
        });

        document.getElementById('baixar-pdf').addEventListener('click', () => {
            window.open('pdfs/glorias-de-Maria-jovens-da-cruz.pdf', '_blank');
        });
